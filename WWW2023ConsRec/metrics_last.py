...
def evaluate(
    ...
    for idx in range(len(test_ratings)):
        ...
        # Important
        # for testing, we put the ground-truth item as the last one and remaining are negative samples
        # for evaluation, we check whether prediction's idx is the ground-truth (last idx)
